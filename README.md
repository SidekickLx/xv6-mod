...
xv6-mod is a modification of xv6. The aim of this project is to make the original xv6 more like a REAL os.

#### Now finished 

1. A Lottery Scheduler
2. A Stride Scheduler
